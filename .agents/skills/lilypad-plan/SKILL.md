...
name: lilypad-plan
description: >-
  Runs the Feature Planning Protocol for Lily Pad. Activate this skill when the user
  asks to build or plan a new feature, update the Firestore database schemas, or
  propose architectural changes. Generates strategy proposals without modifying code.
---

# Feature Planning Protocol

When instructed to plan a new feature or database/architectural shift, you must follow this protocol strictly.
...
*Lily Pad Strategy & Design · Adapted from docs/prompts/PLANNING.md*
