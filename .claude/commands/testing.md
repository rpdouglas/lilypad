Run QA & Verification for Lily Pad.

**Run after `/approve` delivers code. Before any PR is opened.**
...
Run these first. If either fails, stop and run `/fix` before continuing.
...
*Lily Pad Strategy & Design · .claude/commands/testing.md · adapted from docs/prompts/TESTING.md*
