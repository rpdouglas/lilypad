Run the Codebase & Documentation Audit for Lily Pad.
...
Compare `docs/BRAND-TOKENS.md` against `tailwind.config.ts`:
...
*Lily Pad Strategy & Design · .claude/commands/audit.md · adapted from docs/prompts/CODEBASE_AUDIT.md*
