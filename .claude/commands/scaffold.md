...
**Usage:** `/scaffold <type> <name> [persona or folder]`

Types: `page`, `component`, `case-study`, `post`
...
Parse $ARGUMENTS as: `<type> <name> [persona or folder]`

If no arguments were provided, ask:
> "What would you like to scaffold? Options: `page`, `component`, `case-study`, `post`"
...
**Command:** `/scaffold page <Name> [persona]`
...
**Command:** `/scaffold component <Name> [folder]`
...
**Command:** `/scaffold case-study <slug>`
...
*Lily Pad Strategy & Design · .claude/commands/scaffold.md · replaces scripts/antigravity.js*
