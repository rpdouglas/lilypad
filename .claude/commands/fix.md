Run the Error Resolution Protocol for Lily Pad.
...
**Diagnostic step before proposing anything:**
...
3. Do not propose a blind replacement without verifying the surrounding context first
...
Before proposing the fix, confirm:
...
*Lily Pad Strategy & Design · .claude/commands/fix.md · adapted from docs/prompts/FIX.md*
